...
fun CardUsuario(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "ID: ${usuario.idubigeo}",
                modifier = Modifier.align(Alignment.CenterHorizontally)
            )
            Text(
                text = "Nombre: ${usuario.departamento}",
                modifier = Modifier.align(Alignment.CenterHorizontally)
            )
            Row(
                ...
                Button(
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        funIdUsuario(usuario.idubigeo)
                        funNombre(usuario.departamento)
                ...
                Button(
                    modifier = Modifier
                        .padding(horizontal = 4.dp)
                        .weight(1f),
                    onClick = { funBorrarUsuario(usuario.idubigeo) }
                ) {
                    Text(
                        text = "Borrar"
                    )
